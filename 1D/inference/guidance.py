...
def calculate_guidance(state: torch.Tensor, Q: float, config: InferenceConfig) -> torch.Tensor:
...
def get_weight(state: torch.Tensor, Q: float, config: InferenceConfig) -> torch.Tensor:
